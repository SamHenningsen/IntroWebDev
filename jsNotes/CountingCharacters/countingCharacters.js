...
function countingCharacters2(stringToCount, characterToFind){
    /* Let's count the numberof times a character in a string
...
function countingCharacters3 (str, search) {
    ...
    var numChars = search.length;
        /* We need to stop loop based on multiple characters example: if searching "Ohio" with 3 characters at a time we want to stop at
        h so we do not go past the end of the string */
